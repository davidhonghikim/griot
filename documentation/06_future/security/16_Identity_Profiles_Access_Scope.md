...
## Agent Context
**For AI Agents**: Complete identity profiles and access scope system specification covering comprehensive identity modeling, session scoping, and dynamic access resolution. Use this when implementing identity management, role-based access control, or persona-aware interactions. Essential reference for all identity infrastructure and access control work.

**Implementation Notes**: Contains identity modeling patterns, access scope engines, persona overlay systems, and federation protocols. Includes working implementations and integration examples for identity systems.
**Quality Requirements**: Keep identity specifications and access control patterns synchronized with actual identity system implementation. Maintain accuracy of role resolution and permission enforcement mechanisms.
**Integration Points**: Foundation for security architecture, links to trust frameworks, consent systems, and governance models for comprehensive identity coverage.
