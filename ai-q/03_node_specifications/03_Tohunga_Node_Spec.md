---
title: "Tohunga Node Implementation Specification"
description: "Complete technical specification for implementing a HIEROS-compliant Tohunga research and curation node"
type: "implementation"
status: "canonical"
priority: "critical"
last_updated: "2025-01-28"
version: "1.0.0"
agent_notes: "Definitive implementation guide for Tohunga nodes - the research and knowledge curation nodes of the kOS ecosystem"
---

# Tohunga Node Implementation Specification

**Complete Technical Specification for HIEROS-Compliant Tohunga Research & Curation Nodes**

## 🎯 Overview

The Tohunga node is a **Foundation Tier** node class in the kOS ecosystem, responsible for **knowledge acquisition, validation, curation, and scholarly publication**. Inspired by Māori experts and master craftspeople, Tohunga nodes serve as the research librarians and knowledge stewards of the kOS network, ensuring that all information flows maintain the highest standards of accuracy, provenance, and cultural respect.
