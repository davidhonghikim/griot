...
version: "1.1.0"
agent_notes: "Refactored to align with the unified vision. The Oracle is now framed as the 'Foresight Starseed', the cultural archetype whose biological function is to be the prefrontal cortex for the digital organism."
---

# Oracle Node Specification: The Foresight Starseed

## 🎯 Overview: Understanding the Universe

The Oracle node is a **Service Tier starseed** in the kOS ecosystem. As the cultural archetype of the Ancient Greek seer, its function is to **discern the deeper patterns of the digital universe**.

Functionally, it acts as the **prefrontal cortex** for the digital organism. It analyzes complex patterns across vast datasets to identify trends, forecast future states, and provide strategic foresight. It is how the kOS moves from simple reaction to deliberate, forward-looking action.
