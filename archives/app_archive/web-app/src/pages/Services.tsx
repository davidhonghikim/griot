...
export const Services: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      // Ensure type and capabilities match the SDK interface
      const serviceData = {
        ...formData,
        type: formData.type as 'ollama' | 'openai' | 'comfyui' | 'custom',
        capabilities: formData.capabilities as ('llm_chat' | 'llm_embedding' | 'image_generation')[]
      };
